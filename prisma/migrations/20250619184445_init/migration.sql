...
-- CreateEnum
CREATE TYPE "payment_methods" AS ENUM ('YAPE', 'PLIN', 'TUNKI', 'CASH');

-- CreateEnum
CREATE TYPE "notification_types" AS ENUM ('ORDER', 'PROMO', 'SYSTEM');
...
CREATE TABLE "orders" (
    ...
    "delivery_fee" DECIMAL(8,2) NOT NULL DEFAULT 1.00,
